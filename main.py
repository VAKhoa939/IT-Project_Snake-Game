...
class Game:
    def __init__(self) -> None:
        ...
        self.lbl_score_player2 = Textbox(self.window, (1350, 250), 150, 50, '0', prefix = 'Player 2 Score: ')
        self.lbl_node = Textbox(self.window, (1280, 250), 150, 50, '0', prefix = 'Node: ')
        self.lbl_depth = Textbox(self.window, (1430, 250), 150, 50, '0', prefix = 'Depth: ')
        self.lbl_dead = Textbox(self.window, (1350, 300), 150, 50, ' died')
    ...
    def draw_ui_2nd_page(self) -> None:
        ...
        if not self.is_two_player and self.cbb_mode_player1.text != 'Manual':
            self.lbl_node.draw()
            self.lbl_depth.draw()
        elif self.is_two_player:
    ...
    def play_two_players(self) -> None:
        ...
        if self.cbb_mode_player1.text != 'Manual' and self.board.snake2.is_near_dead(self.board.snake1.parts):
            self.board.snake2.find_path(self.cbb_mode_player2.text, self.board.food_id, self.board.snake1.parts)
            self.board.snake2.set_direction()
